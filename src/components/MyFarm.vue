    ...
    <b-container class="container-asset my-4 p-3 px-5">
      <div>
        ...
        <div class = "text-center my-3">
            <b-button v-b-modal.my-assets-transfer size="lg" pill class="mr-2">Retrieve My Asset</b-button>
            <b-button v-b-modal.my-pool-transfer size="lg" pill class="mr-2">Transfer My Assert</b-button>
